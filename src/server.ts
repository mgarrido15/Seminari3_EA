...
const swaggerOptions = {
    ...
    apis: ['./modules/subjects/*.js', './modules/forum/*.js', './modules/users/*.js'] // Asegúrate de que esta ruta apunta a tus rutas
};
...
//mongoose;
mongoose
    .connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/DataBase_Seminari4')
